...
Syntax: pygame.display.set_caption('SIT215 Knights Tour')

from tour import KnightsTour
    ...
    def animate_path(self):
        ...
        while running:
            ...
            while i < (len(self.model.path)):
                ...
                # put i as the tile number as it moves
                i += 1
                time.sleep(0.25)
            running = False

        j = input("Press enter to end")
...
if __name__ == '__main__':
    ...
    kt = KnightsTour(x,y)
    kt.initial_pos = (0, 0) # can change the starting position here
