try:
    import pygame
    from tourPygame import Model, View
...
class KnightsTour:
    ...
    def warnsdorffHeuristic(self, to_visit):
    ...
    def tour(self, n, path, to_visit):
        ...
        if n == self.w * self.h:  # if every grid is filled
            ...
            if rule_location is None:
                sorted_neighbours = self.warnsdorffHeuristic(to_visit)
...
if __name__ == '__main__':
    ...
    # kt.closed_tour = True  # comment out if you want open tour
    kt.initial_pos = (0, 0)
